...
public class EarthMovementMatrix : MonoBehaviour
{
    private GameObject sun;
    float r_x = 1.6F, r_z = 1.2F, delta_rot = 0F, delta_move = 0F, step_size = ((2 * Mathf.PI) / 360F)*0.05F;
    ...
    void Update()
    {
        ...
        var speed_rot = step_size * 365F;
        var speed_move = step_size;
        ...
        Vector3 vector_ep_shifted = vector_ep + sun.transform.position;
